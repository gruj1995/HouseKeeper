...
//
        VictoriaLandmark(latitude: 25.02031126984851, longitude: 121.4667199931189, name: "帝院", details: nil)
//        VictoriaLandmark(latitude: 25.020446375581425, longitude:121.46710212642475, name: "田明", details: nil)
    ]
}
